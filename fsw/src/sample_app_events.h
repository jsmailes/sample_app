...
#define SAMPLE_APP_COMMANDCOOL_INF_EID   5
#define SAMPLE_APP_COMMANDINT_INF_EID    6
#define SAMPLE_APP_INVALID_MSGID_ERR_EID 7
#define SAMPLE_APP_LEN_ERR_EID           8
#define SAMPLE_APP_PIPE_ERR_EID          9
